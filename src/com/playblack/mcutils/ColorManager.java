...
/**
 * Copy of CanaryMods Colors class :P<br>
 * This is extended a bit to be more useful than ever before.
 * @author Chris
 *
 */
public class ColorManager {
    ...
    /**
     * Prepend a color to the stringbuilder. Use the color definitions from ColorManager as color
     * @param msg
     * @param color
     * @return StringBuilder
     */
    public static StringBuilder prependColor(StringBuilder msg, String color) {
    	StringBuilder ret = new StringBuilder(color);
    	ret.append(msg);
    	return ret;
    }
}
